...
$$
n_{p} = n_{p0} \exp\left(\frac{qV}{k_0T}\right) \tag{8-17}
$$

$$
p_{p} = p_{p0} \exp\left(-\frac{qV}{k_0T}\right) \tag{8-18}
$$
...
$$
\color{#E45F59}{F \left( \frac{q V_s}{k T}, \frac{n_{p 0}}{p_{p 0}} \right) = \sqrt{\left[ \exp\left(-\frac{q V}{k_0 T}\right) + \frac{q V}{k_0 T} - 1 \right] + \frac{n_{p0}}{p_{p0}} \left[ \exp\left(\frac{q V}{k_0 T}\right) - \frac{q V}{k_0 T} - 1 \right]}} \tag{8-24}
$$
...
$\color{#E45F59}{q V_B = E_i - E_F = k_0 T \ln{\left(\frac{N_A}{n_i}\right)}}$

强反型层的条件：$\color{#E45F59}{V_{\text{s}} \geq 2 V_B}$
...
$$
\color{#E45F59}
x_{dm} = \left( \frac{4 \varepsilon_{r} \varepsilon_0}{q N_A} V_{B} \right)^{\frac{1}{2}} = \left[ \frac{4 \varepsilon_{r} \varepsilon_0}{q N_A} \frac{k_0 T}{q} \ln{\left(\frac{N_A}{n_i}\right)} \right]^{\frac{1}{2}} \tag{8-57}
$$
